...
class CoreFileUploads
{
    ...
    /**
     * @var \Adteam\Core\Powerbi\Entity\CoreFileUploadReasons
     *
     * @ORM\ManyToOne(targetEntity="Adteam\Core\Powerbi\Entity\CoreFileUploadReasons")
     * @ORM\JoinColumns({
     ...
     * Set reason
     *
     * @param \Adteam\Core\Powerbi\Entity\CoreFileUploadReasons $reason
     *
     * @return CoreFileUploads
     */
    public function setReason(\Adteam\Core\Powerbi\Entity\CoreFileUploadReasons $reason = null)
    {
        $this->reason = $reason;
     ...
     * Get reason
     *
     * @return \Adteam\Core\Powerbi\Entity\CoreFileUploadReasons
     */
